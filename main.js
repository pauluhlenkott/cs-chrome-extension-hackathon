...
/*
1. a start button and stop button
2. Set duration
3. Adding some music
4. exhale enhale image
5. how many times you meditated that day
6. How many minutes total of meditation
*/

//Create a new html page
//when extension is clicked, we will create new tap, whcih will be directed to url: index.html
